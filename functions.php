...
function expo_enqueue_assets() {
    ...
    if (is_search()) {
        wp_enqueue_style('style-search', $theme_uri . '/CSS/search.css');
    }

    if (is_page_template('contact.php') || is_page_template('ar.php')) {
        wp_enqueue_style('style-contact', $theme_uri . '/CSS/contact.css');
    }
