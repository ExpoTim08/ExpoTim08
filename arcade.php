    ...
    <span class="conteneur-section-arcade-bas">
      ...
      <section class="liste-projet-arcade">
        ...
        foreach ($projets as $projet) :
            ...
            $noms_etudiants = array_map(function($e){ return $e->prenom.' '.$e->nom; }, $etudiants);
        ...
        ?>
            <div class="carte-projet-arcade">
              ...
              <?php if(!empty($projet->image_url)) : ?>
                <img class="image-projet-arcade" src="<?php echo esc_url($projet->image_url); ?>" alt="<?php echo esc_attr($projet->titre); ?>">
              <?php else: ?>
