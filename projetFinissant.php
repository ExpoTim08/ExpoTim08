...
<main class="page-graphisme">
  ...
  <!-- Description projet (layout desktop comme Graphisme) -->
  <div class="description-projet">

    <!-- Média principal (video ou image) -->
    <?php if ($video): ?>
    ...
    <?php elseif ($image): ?>
      <div class="image-projet">
        <img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr($nom_affiche); ?>" class="image-projet-graphisme">
      </div>
    <?php endif; ?>
